...
const SearchIdButton = (): JSX.Element => {
      ...
      <Shadow distance={13} offset={[2, 4]} startColor='#00000015' style={styles.searchPillButton}>
        <View style={styles.fill}>
          ...
          <View style={styles.searchPillTextWrapper}>
            <Text style={styles.searchPillMainText}>식별 검색</Text>
            <Text style={styles.searchPillSubText}>Pill Id Search</Text>
          </View>
        </View>
      </Shadow>
    </Button.scale>
